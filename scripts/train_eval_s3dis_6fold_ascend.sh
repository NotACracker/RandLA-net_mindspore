...
python -B eval.py --model_path runs/randla_Area-1-ascend --val_area Area_1 --device_id 0 --device_target Ascend --batch_size 32
...
python -B eval.py --model_path runs/randla_Area-2-ascend --val_area Area_2 --device_id 0 --device_target Ascend --batch_size 32
...
python -B eval.py --model_path runs/randla_Area-3-ascend --val_area Area_3 --device_id 0 --device_target Ascend --batch_size 32
...
python -B eval.py --model_path runs/randla_Area-4-ascend --val_area Area_4 --device_id 0 --device_target Ascend --batch_size 32
...
python -B eval.py --model_path runs/randla_Area-6-ascend --val_area Area_6 --device_id 0 --device_target Ascend --batch_size 32
mkdir ./6_fold_result
